 ...
 */
export function computeCoastDistance(width, height, elevation, seaLevel) {
    ...
    for (let i = 0; i < size; i++) {
        if (!Number.isFinite(coastDist[i]))
            coastDist[i] = 0;
    }
    return coastDist;
}
 ...
 */
export function continentalityFactor(coastDist, maxDist) {
