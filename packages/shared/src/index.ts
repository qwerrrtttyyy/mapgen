...
export { debug, setupDebugGlobal, getDebug, type DebugState, type DebugMetrics, type DebugTiming, type DebugEvent, type DebugSnapshot, type LogLevel } from './debug.js';
